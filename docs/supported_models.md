...
| Phi-3.5-mini-instruct | ✅ | MHA packed qkv (paged) | ✅ | [#289](https://github.com/vllm-project/vllm-metal/issues/289) | Validated on MacBook Pro (Apple M4 Max, 64 GB) on macOS 26.3.1 with `mlx-community/Phi-3.5-mini-instruct-4bit`; greedy output matches `mlx_lm` reference |
