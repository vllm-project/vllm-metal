    ...
    uint lane [[thread_index_in_simdgroup]])
{
  ...
  // Precompute scale in log2 space
...
#pragma unroll
    ...
    // Each simdgroup: softmax on its 2 rows, then rescale its O rows.
    {
...
#pragma unroll
      for (int ri = 0; ri < ROWS_PER_SG; ri++) {
        ...
        // Read score, apply scale + mask inline
...
// ---- Tiled kernel template instantiation macros ----
