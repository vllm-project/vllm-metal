...
# behaviourally identical to what users get today. The deployment target matches
# the macOS 15 CI/release runner; without it, newer local Xcode toolchains can
# emit Metal libraries that macOS 15 cannot load.
_METALLIB_FLAGS = (
    "xcrun",
    "-sdk",
    "macosx",
